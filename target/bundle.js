var gatling = (() => {
  ...
  // node_modules/@gatling.io/core/target/gatlingJvm/byteArrays.js
  var require_byteArrays = __commonJS({
    "node_modules/@gatling.io/core/target/gatlingJvm/byteArrays.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.asByteArrayFunction = exports.asByteArray = void 0;
      var ByteArrays = Java.type("io.gatling.js.callbacks.ByteArrays");
      var asByteArray = (v) => ByteArrays.asByteArray(v);
      exports.asByteArray = asByteArray;
      var asByteArrayFunction = (f) => ByteArrays.asByteArrayFunction(f);
  ...
  var require_session = __commonJS({
    "node_modules/@gatling.io/core/target/session.js"(exports) {
      ...
      var byteArrays_1 = require_byteArrays();
  ...
  // node_modules/@gatling.io/core/target/gatlingJvm/resources.js
  var require_resources = __commonJS({
    "node_modules/@gatling.io/core/target/gatlingJvm/resources.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.readResourceAsString = exports.readResourceAsBytes = void 0;
      var Resources = Java.type("io.gatling.js.Resources");
      var readResourceAsBytes = (filePath) => Resources.readResourceAsBytes(filePath);
      exports.readResourceAsBytes = readResourceAsBytes;
      var readResourceAsString = (filePath, charset) => Resources.readResourceAsString(filePath, charset !== void 0 ? charset : "utf-8");
  ...
  var require_body = __commonJS({
    "node_modules/@gatling.io/core/target/body.js"(exports) {
      ...
      var StringBody2 = (string) => wrapBodyWithString(typeof string === "function" ? jvm_types_1.CoreDsl.StringBody((0, session_1.underlyingSessionTo)(string)) : jvm_types_1.CoreDsl.StringBody(string));
      exports.StringBody = StringBody2;
      ...
      var ByteArrayBody = (bytes) => wrapBodyWithBytes(typeof bytes === "function" ? jvm_types_1.CoreDsl.ByteArrayBody((0, byteArrays_1.asByteArrayFunction)((0, session_1.underlyingSessionTo)(bytes))) : typeof bytes === "string" ? jvm_types_1.CoreDsl.ByteArrayBody(bytes) : jvm_types_1.CoreDsl.ByteArrayBody(bytes));
  ...
  var require_checks = __commonJS({
    "node_modules/@gatling.io/core/target/checks/index.js"(exports) {
      ...
      var bodyBytes = () => ({
        ...
        is: (expected) => (0, final_1.wrapCheckBuilderFinal)(typeof expected === "function" ? jvm_types_1.CoreDsl.bodyBytes().is((0, byteArrays_1.asByteArrayFunction)((0, session_1.underlyingSessionTo)(expected))) : jvm_types_1.CoreDsl.bodyBytes().is((0, byteArrays_1.asByteArray)(expected))),
        not: (expected) => (0, final_1.wrapCheckBuilderFinal)(typeof expected === "function" ? jvm_types_1.CoreDsl.bodyBytes().not((0, byteArrays_1.asByteArrayFunction)((0, session_1.underlyingSessionTo)(expected))) : jvm_types_1.CoreDsl.bodyBytes().not((0, byteArrays_1.asByteArray)(expected)))
      });
  ...
  var require_openInjection = __commonJS({
    "node_modules/@gatling.io/core/target/openInjection.js"(exports) {
      ...
      var constantUsersPerSec = (rate) => wrapOpenInjectionStepConstantRate(jvm_types_1.CoreDsl.constantUsersPerSec(rate));
  ...
  // node_modules/@gatling.io/core/target/parameters.js
  var require_parameters = __commonJS({
    "node_modules/@gatling.io/core/target/parameters.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.getEnvironmentVariable = exports.getOption = exports.getParameter = void 0;
      var jvm_types_1 = require_jvm_types();
      var getParameter = (key, defaultValue) => getOrElse(jvm_types_1.System.getProperty(key), defaultValue);
      exports.getParameter = getParameter;
      exports.getOption = exports.getParameter;
      var getEnvironmentVariable = (name, defaultValue) => getOrElse(jvm_types_1.System.getenv(name), defaultValue);
      exports.getEnvironmentVariable = getEnvironmentVariable;
      var getOrElse = (value, defaultValue) => typeof value === "string" ? value : defaultValue;
    }
  });
  ...
  var require_errors = __commonJS({
    "node_modules/@gatling.io/core/target/structure/errors.js"(exports) {
      ...
      var errorsImpl = (jvmErrors, wrap) => ({
        ...
        stopLoadGenerator: (message) => wrap(typeof message === "function" ? jvmErrors.stopLoadGenerator((0, session_1.underlyingSessionTo)(message)) : jvmErrors.stopLoadGenerator(message)),
        ...
        crashLoadGenerator: (message) => wrap(typeof message === "function" ? jvmErrors.crashLoadGenerator((0, session_1.underlyingSessionTo)(message)) : jvmErrors.crashLoadGenerator(message)),
  ...
  var require_target = __commonJS({
    "node_modules/@gatling.io/core/target/index.js"(exports) {
      ...
      var session_1 = require_session();
      var collections_1 = require_collections();
      Object.defineProperty(exports, "asJava", { enumerable: true, get: function() {
        return collections_1.asJava;
      } });
      var byteArrays_1 = require_byteArrays();
      Object.defineProperty(exports, "asByteArray", { enumerable: true, get: function() {
        return byteArrays_1.asByteArray;
      } });
      Object.defineProperty(exports, "asByteArrayFunction", { enumerable: true, get: function() {
        return byteArrays_1.asByteArrayFunction;
      } });
      var resources_1 = require_resources();
      Object.defineProperty(exports, "readResourceAsBytes", { enumerable: true, get: function() {
        return resources_1.readResourceAsBytes;
      } });
      Object.defineProperty(exports, "readResourceAsString", { enumerable: true, get: function() {
        return resources_1.readResourceAsString;
      } });
      ...
      Object.defineProperty(exports, "getParameter", { enumerable: true, get: function() {
        return parameters_1.getParameter;
      } });
      Object.defineProperty(exports, "getOption", { enumerable: true, get: function() {
        return parameters_1.getOption;
      } });
      Object.defineProperty(exports, "getEnvironmentVariable", { enumerable: true, get: function() {
        return parameters_1.getEnvironmentVariable;
      } });
      ...
      var simulation2 = (simulation3) => (jvmSetUp) => {
        simulation3((...populationBuilders) => wrapSetUp(jvmSetUp(populationBuilders.map((p) => p._underlying))));
      };
      exports.simulation = simulation2;
    }
  });
  ...
  var require_protocol2 = __commonJS({
    "node_modules/@gatling.io/http/target/protocol.js"(exports) {
      ...
      var wrapHttpProtocolBuilder = (_underlying) => ({
        ...
        proxyProtocolSourceIpV4Address: (address) => (0, exports.wrapHttpProtocolBuilder)(typeof address === "string" ? _underlying.proxyProtocolSourceIpV4Address(address) : _underlying.proxyProtocolSourceIpV4Address((0, core_1.underlyingSessionTo)(address))),
        proxyProtocolSourceIpV6Address: (address) => (0, exports.wrapHttpProtocolBuilder)(typeof address === "string" ? _underlying.proxyProtocolSourceIpV6Address(address) : _underlying.proxyProtocolSourceIpV6Address((0, core_1.underlyingSessionTo)(address))),
        // DNS part
  ...
  __export(stdin_exports, {
    computerdatabase: () => computerdatabase_gatling_default
  });

  // src/computerdatabase.gatling.ts
  var import_core2 = __toESM(require_target(), 1);
  var import_http2 = __toESM(require_target2(), 1);

  // src/actions/backend/backend-actions.ts
  var import_core = __toESM(require_target(), 1);
  var import_http = __toESM(require_target2(), 1);
  var BackendAction = class _BackendAction {
    constructor({ name, method, url, body }) {
      this.body = null;
      this.name = name;
      this.method = method;
      this.url = url;
    ...
    buildHttp() {
      ...
      switch (this.method) {
        case 0 /* GET */:
          httpBuilder = (0, import_http.http)(this.name).get(this.url);
          break;
        case 1 /* POST */:
          httpBuilder = (0, import_http.http)(this.name).post(this.url);
          break;
        case 2 /* PUT */:
          httpBuilder = (0, import_http.http)(this.name).put(this.url);
          break;
        case 3 /* DELETE */:
          httpBuilder = (0, import_http.http)(this.name).delete(this.url);
          break;
        case 4 /* HEAD */:
          httpBuilder = (0, import_http.http)(this.name).head(this.url);
          break;
        case 5 /* OPTIONS */:
          httpBuilder = (0, import_http.http)(this.name).options(this.url);
          break;
        case 6 /* PATCH */:
          httpBuilder = (0, import_http.http)(this.name).patch(this.url);
          break;
        default:
      ...
      if (this.body) {
        ...
        if (typeof this.body === "object")
          ...
          body = this.body;
        httpBuilder.body((0, import_core.StringBody)(body));
      }
      return httpBuilder;
    }
    setBody(body) {
  ...
  var BackendService = class {
    constructor() {
      this.homeEndpoint = new BackendAction({
        name: "Home",
        method: 0 /* GET */,
        url: "/"
      });
      this.searchEndpoint = new BackendAction({
        name: "Search",
        method: 0 /* GET */,
        url: "/computers"
      });
      this.selectEndpoint = new BackendAction({
        name: "Select",
        method: 0 /* GET */,
        url: "/"
      });
  ...
  var backend_actions_default = BackendService;

  // src/computerdatabase.gatling.ts
  var computerdatabase_gatling_default = (0, import_core2.simulation)((setUp) => {
    const feeder = (0, import_core2.csv)("search.csv").random();
    const backendService = new backend_actions_default();
    const selectEndpoint = backendService.selectEndpoint.clone();
    selectEndpoint.setName("Select");
    selectEndpoint.setUrl("#{computerUrl}");
    const search = (0, import_core2.exec)(
      backendService.homeEndpoint.buildHttp(),
      (0, import_core2.pause)(1),
      (0, import_core2.feed)(feeder),
      backendService.searchEndpoint.buildHttp().formParam("f", "#{searchCriterion}").check((0, import_core2.css)("a:contains('#{searchComputerName}')", "href").saveAs("computerUrl")),
      (0, import_core2.pause)(1),
      selectEndpoint.buildHttp().check((0, import_http2.status)().is(200)),
      (0, import_core2.pause)(1)
    );
    const browse = (
      // Note how we force the counter name, so we can reuse it
      (0, import_core2.repeat)(4, "i").on(
        backendService.createEndpoint({
          name: "Page #{i}",
          method: 0 /* GET */,
          url: "/computers?p=#{i}"
        }).setBody("1234").buildHttp(),
        (0, import_core2.pause)(1)
      )
    );
    const edit = (
      // let's try at max 2 times
      (0, import_core2.tryMax)(2).on(
        (0, import_http2.http)("Form").get("/computers/new"),
        (0, import_core2.pause)(1),
        (0, import_http2.http)("Post").post("/computers").formParam("name", "Beautiful Computer").formParam("introduced", "2012-05-30").formParam("discontinued", "").formParam("company", "37").check(
          (0, import_http2.status)().is(
            // we do a check on a condition that's been customized with
            // a lambda. It will be evaluated every time a user executes
            // the request
            (session) => 200 + Math.floor(Math.random() * 2)
            // +0 or +1 at random
          )
        )
      ).exitHereIfFailed()
    );
    const httpProtocol = import_http2.http.baseUrl("https://computer-database.gatling.io").acceptHeader("text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8").acceptLanguageHeader("en-US,en;q=0.5").acceptEncodingHeader("gzip, deflate").userAgentHeader(
      "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:109.0) Gecko/20100101 Firefox/119.0"
    );
    const users = (0, import_core2.scenario)("Users").exec(search, browse);
    const admins = (0, import_core2.scenario)("Admins").exec(search, browse, edit);
    setUp(
      users.injectOpen((0, import_core2.rampUsers)(10).during(10)),
      admins.injectOpen((0, import_core2.rampUsers)(2).during(10))
